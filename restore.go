...
// func reduceToRepoRoots(deps []Dependency) error {
// 	for _, dep := range deps {
// 		rr, err := vcs.RepoRootForImportPath(dep.ImportPath, verbose)
// 		if err != nil {
// 			return err
// 		}
...
// Two phases
// 1. Locate where package should be;
// 2. Checkout specific rev of package.
